...
class CategoryServiceImplTest {
    ...
    class CategoryTest {
        ...
        class UpdateTest {
            ...
            void updateCategory_WhenNoFoundCategoryDataThenNotFoundException() {
                ...
                CategoryUpdateDto mockUpdateDto =
                        new CategoryUpdateDto().builder().categoryId(nullCategoryId).build();
                // mock
    ...
    class BbsTest {
        ...
        class SelectTest {
            ...
            @Test
            @DisplayName(
                    "게시판리스트 조회시 조회하고자 하는 Status가 Enum에 존재하고, 카테고리Id도 존재하는 경우, 해당 항목과 일치하는 값을 가진 게시판 리스트를 획득한다.")
