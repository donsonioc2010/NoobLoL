...
class LetterControllerTest {
    ...
    void getLetter_WhenRequireUserIsToOrFromLetterUser_ThenReturnLetterContent() throws Exception {
        ...
        mockMvc
                .perform(
                        RestDocumentationRequestBuilders.get("/letter/{letterId}", reqLetterId)
                                .session(reqSession))
                .andExpect(jsonPath("$.resultCode", Is.is(HttpStatus.OK.value())))
                .andDo(
                        document(
                                "user/letter/getLetter",
                                pathParameters(parameterWithName("letterId").description("조회 할 쪽지의 ID")),
                                ...
                                responseFields(
                                        ...
                                        fieldWithPath("result.letterId")
                                                .type(JsonFieldType.NUMBER)
                                                .description("쪽지 ID"),
                                        fieldWithPath("result.letterTitle")
                                                .type(JsonFieldType.STRING)
                                                .description("쪽지 제목"),
                                        fieldWithPath("result.letterContent")
                                                .type(JsonFieldType.STRING)
                                                .description("쪽지 내용"),
                                        fieldWithPath("result.toUserId")
                                                .type(JsonFieldType.STRING)
                                                .description("쪽지 수신자"),
                                        fieldWithPath("result.toStatus")
                                                .type(JsonFieldType.STRING)
                                                .description("수신자의 쪽지 상태"),
                                        fieldWithPath("result.fromUserId")
                                                .type(JsonFieldType.STRING)
                                                .description("쪽지 발신자"),
                                        fieldWithPath("result.fromStatus")
                                                .type(JsonFieldType.STRING)
    ...
    void getLetterToList_WhenRequireType_ThenReturnLetterReqTypeList() throws Exception {
        ...
        mockMvc
                .perform(
                        RestDocumentationRequestBuilders.get("/letter/list/{type}", type)
                ...
                .andDo(
                        document(
                                ...
                                pathParameters(parameterWithName("type").description("조회 할 쪽지의 ID")),
                                requestParameters(
    ...
    void insertLetter_WhenInsertSuccess_ThenReturnTrueAndOk() throws Exception {
        // given
        LetterInsertRequestDto requestToLetterDto =
        ...
        // mock
        when(letterService.insertLetter(any(LetterInsertRequestDto.class), any(HttpSession.class)))
                .thenReturn(true);
    ...
    void deleteLetter_WhenDeleteSuccess_ThenReturnTrueAndOk() throws Exception {
        ...
        mockMvc
                .perform(
                        RestDocumentationRequestBuilders.delete("/letter/{type}/{letterId}", type, letterId)
                                .session(session))
                .andExpect(jsonPath("$.resultCode", Is.is(HttpStatus.OK.value())))
                .andExpect(jsonPath("$.result", Is.is(true)))
                .andDo(
