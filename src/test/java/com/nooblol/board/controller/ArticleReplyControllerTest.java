...
class ArticleReplyControllerTest {
    ...
    @MockBean ArticleReplyService articleReplyService;
    ...
    void updateReply_WhenUpdateSuccess_ThenReturnOkAndTrue() throws Exception {
        ...
        // mock
        when(articleReplyService.updateReply(any(ReplyUpdateDto.class), any(HttpSession.class)))
                .thenReturn(true);
    ...
    void deleteReply_WhenDeleteSuccess_ThenReturnOkAndTrue() throws Exception {
        ...
        // mock
        when(articleReplyService.deleteReplyByReplyId(replyId, session)).thenReturn(true);
