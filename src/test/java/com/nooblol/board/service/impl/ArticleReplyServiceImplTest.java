...
class ArticleReplyServiceImplTest {
    ...
    @Mock private ArticleReplyMapper articleReplyMapper;

    @Mock private ArticleService articleService;

    @InjectMocks private ArticleReplyServiceImpl articleReplyService;
    ...
    void insertReply_WhenDbNotHaveArticleThenBadRequestException() {
        ...
        ReplyInsertDto replyInsertDto = new ReplyInsertDto().builder().articleId(testArticleId).build();
        // mock
        doThrow(new IllegalArgumentException(ExceptionMessage.BAD_REQUEST))
                .when(articleService)
                .checkNotExistsArticleByArticleId(testArticleId);
    ...
    void insertReply_WhenInsertSuccessThenBadReReturnTrue() {
        ...
        ReplyInsertDto replyInsertDto =
                new ReplyInsertDto().builder().articleId(testArticleId).status(ReplyStatus.ACTIVE).build();
    ...
    void updateReply_WhenDbNotHaveArticleThenBadRequestException() {
        ...
        ReplyUpdateDto replyUpdateDto =
                new ReplyUpdateDto().builder().articleId(testArticleId).replyId(testReplyId).build();
        // mock
        doThrow(new IllegalArgumentException(ExceptionMessage.BAD_REQUEST))
                .when(articleService)
                .checkNotExistsArticleByArticleId(testArticleId);
    ...
    void updateReply_WhenIsCreatedUserAndSuccessUpdateThenReturnTrue() {
        ...
        when(articleReplyMapper.selectCreatedUserIdByReplyId(testReplyId))
                .thenReturn(SessionUtils.getSessionUserId(authUserSession));
        when(articleReplyMapper.updateReply(any())).thenReturn(1);
    ...
    void deleteReply_WhenIsCreatedUserAndDeleteSuccessThenReturnTrue() {
        ...
        // mock
        when(articleReplyMapper.selectCreatedUserIdByReplyId(testReplyId)).thenReturn("test");
    ...
    class ArticleReplySelectTest {
        ...
        class SelectList {
            ...
            void selectReplyListByArticleId_WhenIsNotExistsArticle_ThenBadRequestException() {
                ...
                doThrow(new IllegalArgumentException(ExceptionMessage.BAD_REQUEST))
                        .when(articleService)
                        .checkNotExistsArticleByArticleId(nullArticleId);
                // when
                Exception e =
                        assertThrows(
                                IllegalArgumentException.class,
            ...
            void selectReplyListByArticleId_WhenIsExistsArticleAndIsExistsReply_ThenReturnReplyList() {
                ...
                // mock
                when(articleReplyMapper.selectReplyListByArticleId(existsArticleId))
