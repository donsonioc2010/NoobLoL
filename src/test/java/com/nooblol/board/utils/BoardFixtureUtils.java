...
public class BoardFixtureUtils {
    ...
    public static List<BbsDto> BbsAllCategoryListFixtureByAdminUserID(String adminUserId) {
        List<BbsDto> responseList = new ArrayList<BbsDto>();
        responseList.add(
                new BbsDto()
                        .builder()
