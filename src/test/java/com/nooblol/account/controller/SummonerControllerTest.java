...
class SummonerControllerTest {
    ...
    @MockBean SummonerService summonerService;

    @MockBean SummonerHistoryService summonerHistoryService;
    ...
    void searchSummonerByName_WhenIsExistsSummoner_ThenReturnOkAndSummonerInfo() throws Exception {
        ...
        mockMvc
                .perform(
                        MockMvcRequestBuilders.get("/summoner/search/name")
                ...
                .andDo(
                        document(
                                ...
                                responseFields(
                                        ...
                                        fieldWithPath("result.profileIconId")
                                                .type(JsonFieldType.NUMBER)
                                                .description("현재 사용중인 프로필 아이콘 ID"),
                                        fieldWithPath("result.revisionDate")
                                                .type(JsonFieldType.NUMBER)
                                                .description("소환사의 정보가 마지막으로 변경된 시간"),
                                        fieldWithPath("result.summonerLevel")
                                                .type(JsonFieldType.NUMBER)
    ...
    void searchSummonerHistoryById_WhenISExistsSummoner_ThenReturnOkAndHistoryData()
        ...
        // mock
        when(summonerHistoryService.getSummonerHistoryInfo(requestSummonerId, requestSyncValue))
                .thenReturn(okResponseDto);

        // when & then
        mockMvc
                .perform(
                        MockMvcRequestBuilders.get("/summoner/history")
