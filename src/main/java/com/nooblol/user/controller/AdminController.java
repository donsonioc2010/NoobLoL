...
public class AdminController {
    ...
    public ResponseDto deleteForcedUser(
            @PathVariable(required = false) @NotBlank(message = AdminConstants.ADMIN_DELETEUSERID_NULL)
                    String deleteUserId) {
    ...
    public ResponseDto changeToActiveUser(
            @PathVariable(required = false) @NotBlank(message = UserConstants.USER_ID_NULL)
                    String changeUserId) {
